...
# =============================================================================
# Úkol 1
# Načtěte obraz initial_image.jpg do prostředí Python a zobrazte jej (skimage.io.imread, plt.imshow).
...
# Zobrazte vedle sebe histogram zvektorizovaného barevného obrazu a histogram šedotónového obrazu.
# Pozorujte rozdíly a diskutujte.
# =============================================================================
